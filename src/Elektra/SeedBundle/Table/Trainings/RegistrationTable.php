 ...
 * @version 0.1-dev
 */
class RegistrationTable extends CRUDTable
{
    ...
    protected function setupHeader(Row $header)
    {
        ...
        $registrantCell->addHtmlContent('Registrant');
    ...
    protected function setupContentRow(Row $content, CRUDEntityInterface $entry)
    {
        ...
        if (!$entry instanceof Registration) {
            throw new \InvalidArgumentException('Can only display entries of type "Registration"');
        }
