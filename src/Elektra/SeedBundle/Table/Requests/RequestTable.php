...
class RequestTable extends Table
{
    ...
    protected function initialiseColumns()
    {
        ...
        $requestNumber = $this->getColumns()->addTitleColumn('tables.requests.request.request_number');
        $requestNumber->setFieldData('requestNumber');
        $requestNumber->setSearchable();
        $requestNumber->setSortable();

        $company = $this->getColumns()->add('tables.requests.request.company');
        ...
        $requester = $this->getColumns()->add('tables.requests.request.requester');
        ...
        $receiver = $this->getColumns()->add('tables.requests.request.receiver');
        ...
        $shippingAddress = $this->getColumns()->add('tables.requests.request.shipping_location');
